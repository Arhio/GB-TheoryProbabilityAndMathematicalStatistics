...
if __name__ == '__main__':
    ...
    lesson.Task_1(16, 80, 256, 0.95)

    lesson.Task_1(5, 24.15, 100, 0.95)
    'При неизвесной генеральной совокпности'
    lesson.Task_2([6.9, 6.1, 6.2, 6.8, 7.5, 6.3, 6.4, 6.9, 6.7, 6.1], 0.95)
    ''
    lesson.Task_3(17, 17.5, 4, 0.05, 100)
    lesson.Task_4(200, [202, 203, 199, 197, 195, 201, 200, 204, 194, 190], 0.99)
